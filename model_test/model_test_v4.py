...
def test_model(sample_path, urdf_path, model_path, output_path):
    ...
    f = open(os.path.join(output_path, "results4.log"), 'w')
    ...
    for sample in sample_path:
        ...
        path = os.path.join(output_path,"fig_4",sample.split("/")[-1])
...
def main():
    ...
    model_path = "/home/cedra/psl_project/sign_language_pose_model_v4.0_5_best.pth"
